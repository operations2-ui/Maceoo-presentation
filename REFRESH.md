...
```bash
python3 tools/periods.py          # 1. recompute the windows, print the 21 queries
...
| `monthly_by_store.csv` | month, store, net_sales, orders, units | `monthly_by_store` |
...
it is bookkeeping rather than a merchandising category.
